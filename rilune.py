...
api_id = int(os.getenv('TG_API_ID', '30211539'))
api_hash = os.getenv('TG_API_HASH', '5667f6c39adffd5009b3a906b598ce2d')
...
DEFAULT_ALLOWED_USERS = {2097619133, 1538087933}  # Ganti dengan ID admin awal
